      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600"> Baldev Nagar,</p>
                    <p className="text-gray-600">Jodhpur, Rajasthan 342003</p>
            ...
            {/* Business Hours */}
              <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
                <h2 className="text-2xl font-semibold text-gray-800 mb-4">Dudaram Choudhary</h2>
                <span className="block text-lg font-medium text-gray-700 mb-2">Software Engineer</span>
                <p className="text-gray-600 leading-relaxed">
                  Passionate Software Engineer with experience in building scalable web applications,
                  test automation, and modern frontend development. Skilled in React, Node.js, and Cypress,
                  with a focus on delivering clean and efficient solutions.
                </p>
              </div>
          </div>
        </div>
